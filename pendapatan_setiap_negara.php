                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT COUNT(c.CustomerType) as CustomerStore 
                                                 FROM customer_dimension c
                                                 JOIN (select distinct customer_id from fact_table_sales) fs 
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT COUNT(c.CustomerType) as Customer_Individu 
                                            FROM customer_dimension c
                                            JOIN (select distinct customer_id from fact_table_sales) fs 
                                            ON (c.customer_id = fs.customer_id) 
                                            ...
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['Customer_Individu'],0,".",",");
                                                 }
                                            ?>
                                            </div>
                                        </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body-store">
                                    <div class="chart-area-store">
                                        ...
                                        $sql = "SELECT CONCAT('name:',s.Group) as benua, CONCAT('y:', SUM(fs.Total)*100/" . $tot_amount[0] .") as y, CONCAT('drilldown:', s.Group) as drilldown 
                                        FROM salesterritory s 
                                        JOIN factsales fs ON (s.TerritoryID = fs.TerritoryID) 
                                        GROUP BY benua 
                                        ORDER BY y DESC";
                                        ...
                                        $sql = "SELECT s.Group benua, sum(fs.Total) as tot_kat
                                        FROM factsales fs
                                        JOIN salesterritory s ON (s.TerritoryID = fs.TerritoryID)
                                        GROUP BY benua";
                                        ...
                                        $sql = "SELECT s.Group benua, s.Name as negara, SUM(fs.Total) as pendapatan_kat
                                        FROM salesterritory s
                                        JOIN factsales fs ON (s.TerritoryID = fs.TerritoryID)
                                        -- JOIN time t ON (t.time_id = fp.time_id)
                                        GROUP BY benua, negara";
