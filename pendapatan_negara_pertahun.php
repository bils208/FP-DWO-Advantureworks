...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Penjualan Setiap Negara Per Tahun</h1>
                    </div>
                        ...
                        <div class="col-xl-8 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Pendapatan Tiap Negara</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body-store">
                                    <div class="chart-area-store">
                                        ...
                                        $sql = "SELECT CONCAT('name:',p.Name) as negara, CONCAT('y:', SUM(fs.Total)*100/" . $tot_amount[0] .") as y, CONCAT('drilldown:', p.Name) as drilldown 
                                        FROM salesterritory p 
                                        JOIN factsales fs ON (p.TerritoryID = fs.TerritoryID) 
                                        GROUP BY negara 
                                        ORDER BY y DESC";
                                        ...
                                        $sql = "SELECT p.Name negara, sum(fs.Total) as tot_kat
                                        FROM factsales fs
                                        JOIN salesterritory p ON (p.TerritoryID = fs.TerritoryID)
                                        GROUP BY negara";
                                        ...
                                        $sql = "SELECT p.Name negara, d.Year as tahun, SUM(fs.Total) as pendapatan_kat
                                        FROM salesterritory p
                                        JOIN factsales fs ON (p.TerritoryID = fs.TerritoryID)
                                        JOIN date d ON (d.DateID = fs.DateID)
                                        GROUP BY negara, tahun";
    ...
    // Create the chart
        ...
        title: {
            text: 'Persentase Nilai Penjualan (AdventureWorks) Setiap Negara Per Tahun'},
            subtitle: {
                text:'Klik di potongan kue untuk melihat detil nilai penjualan tiap negara per tahun'
            },
            accessibility: {
                announceNewData: {
                    enabled: true
